...
var _defaultPlaceholderDisplay = require('./utils/defaultPlaceholderDisplay');

var _defaultPlaceholderDisplay2 = _interopRequireDefault(_defaultPlaceholderDisplay);
...
var Select = function (_React$Component) {
   ...
   */
		...
		value: function renderPlaceholder(valueArray, isOpen) {
			return this.props.placeholderDisplay(valueArray, isOpen, this.state.inputValue) ? _react2.default.createElement(
				'div',
...
Select.propTypes = {
	...
	placeholderDisplay: _propTypes2.default.func, // boolean to show placeholder (valueArray, isOpen, inputValue)
...
Select.defaultProps = {
	...
	pageSize: 5,
	placeholder: 'Select...',
	placeholderDisplay: _defaultPlaceholderDisplay2.default,
	required: false,
